export function BrandHeader() {
  return (
    <div className="mb-8 flex flex-col items-center text-center">
      <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-[9px] bg-brand">
        <svg viewBox="0 0 14 14" fill="none" className="h-5 w-5">
      ...
      <span className="text-lg font-medium tracking-wide text-brand-dark">
        Lumio
      </span>
